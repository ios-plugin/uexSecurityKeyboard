...
- (void)customView:(CGRect)frame{
    ...
    [self setCharKeyboard:1000 count:10 distance:5 titles:titles1 buttonTag:200];
    [self setCharKeyboard:1001 count:9 distance:25 titles:titles2 buttonTag:210];
    //----------------------------------------------------
    ...
    [btn setImage:[self imagesNamedFromCustomBundle:@"key_icon_shift_highlighted.png"] forState:UIControlStateNormal];
    ...
    [self setCharKeyboard:1002 count:7 distance:65 titles:titles3 buttonTag:219];
    //------------------------------------------------------
